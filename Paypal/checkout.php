...
if ( $PaymentOption == "PayPal")
{
        ...
        //'------------------------------------
        $returnURL = "https://proarcfull-x14500057-1.c9users.io/tradesman-dashboard/tradesmandashboard.php";
        ...
        //' This is set to the value entered on the Integration Assistant 
        //'------------------------------------
        $cancelURL = "https://proarcfull-x14500057-1.c9users.io/Paypal/cancel.php";
